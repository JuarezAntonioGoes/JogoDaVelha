...
public class JogoDaVelha extends JFrame {
	...
	String nome1 = JOptionPane.showInputDialog("Nome do primeiro participante: ");
	String nome2 = JOptionPane.showInputDialog("Nome do segundo participante: ");
	JButton nomep = new JButton();
	public JogoDaVelha() {
		setVisible(true);
		setTitle("Jogo da velha entre: "+ nome1+ " e "+ nome2);
		...
		add(nomep);
		nomep.setBounds((400), (200), 250, 95);
		nomep.setFont(new Font("Arial", Font.BOLD,15));
		nomep.setText("É a vez de: "+nome1);
	...
	private void ganhou() {
		...
		for (int i = 0; i < 9; i++) {
			if(click[i] == true) {
				if(cont%2 == 0) {
					nomep.setText("É a vez de: "+nome2);
